...
let animalName: string[] = ["cow", "horse", "donkey"];
...
for (const animal of animalName) {
  if (animal === "cow") {
    ...
    console.log(
      `${animal} are powerful and tall animals that can run very fast.`
    );
...
console.log(
  "Horses,Donkeys and cows are herbivorous animals that mainly feed on grasses and plants."
);
