...
let umbrella = "OnRainyWeather";
// false:
console.log("We need umbrella on dry weatehr umbrella == OnDryWeather? I think so this is false");
console.log(umbrella == "OnDryWeather");
// True:
console.log("We need umbrella on Rainy weatehr umbrella === OnRainyWeather? I think so this is True");
